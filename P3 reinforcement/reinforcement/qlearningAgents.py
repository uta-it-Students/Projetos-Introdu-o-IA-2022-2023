...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        return values.argMax() #maxKey in dict values
    ...
    def getAction(self, state):
        ...
        action = random.choice(legal_actions) if util.flipCoin(self.epsilon) else self.computeActionFromQValues(state)
        return action
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        q_value = [features[key] * self.weights[key] for key in features]
        return sum(q_value)
    ...
    def update(self, state, action, nextState, reward: float):
        ...
        difference = reward - q_value_current_state + self.discount * q_value_next_state
